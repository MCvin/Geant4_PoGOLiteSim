...
//=========  (Tue Dec  3 16:19:52 2013) by ROOT version5.34/09
   ...
   M2->SetBinContent(1,2882);
   M2->SetBinContent(2,3092);
   M2->SetBinContent(3,3080);
   M2->SetBinContent(4,3036);
   M2->SetBinContent(5,3174);
   M2->SetBinContent(6,3093);
   M2->SetEntries(18357);
   ...
   Mf->SetParameter(0,3058.647);
   Mf->SetParError(0,22.57817);
   Mf->SetParLimits(0,0,0);
   Mf->SetParameter(1,-0.03434812);
   Mf->SetParError(1,0.01037153);
   Mf->SetParLimits(1,0,0);
   Mf->SetParameter(2,22.67748);
   Mf->SetParError(2,8.760917);
