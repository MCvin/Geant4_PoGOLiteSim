...
//=========  (Tue Dec  3 16:24:46 2013) by ROOT version5.34/09
   ...
   M2->SetBinContent(1,2873);
   M2->SetBinContent(2,2985);
   M2->SetBinContent(3,3053);
   M2->SetBinContent(4,3016);
   M2->SetBinContent(5,3186);
   M2->SetBinContent(6,3166);
   M2->SetEntries(18279);
   ...
   Mf->SetParameter(0,3044.49);
   Mf->SetParError(0,22.52586);
   Mf->SetParLimits(0,0,0);
   Mf->SetParameter(1,-0.03377955);
   Mf->SetParError(1,0.0103802);
   Mf->SetParLimits(1,0,0);
   Mf->SetParameter(2,34.23028);
   Mf->SetParError(2,8.941939);
