...
//=========  (Tue Dec  3 16:23:37 2013) by ROOT version5.34/09
   ...
   M2->SetBinContent(1,2786);
   M2->SetBinContent(2,3042);
   M2->SetBinContent(3,3082);
   M2->SetBinContent(4,3044);
   M2->SetBinContent(5,3082);
   M2->SetBinContent(6,3111);
   M2->SetEntries(18147);
   ...
   Mf->SetParameter(0,3022.534);
   Mf->SetParError(0,22.44448);
   Mf->SetParLimits(0,0,0);
   Mf->SetParameter(1,-0.03804124);
   Mf->SetParError(1,0.01041055);
   Mf->SetParLimits(1,0,0);
   Mf->SetParameter(2,34.99268);
   Mf->SetParError(2,7.973727);
