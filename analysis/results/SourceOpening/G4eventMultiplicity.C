...
//=========  (Wed Nov 13 10:11:40 2013) by ROOT version5.34/11
   ...
   G4eventMultiplicity->Range(-1.25,-18.88575,11.25,169.9718);
   ...
   EM->SetBinContent(2,143.8914);
   EM->SetBinContent(3,137.8586);
   EM->SetBinContent(4,112.5921);
   EM->SetBinContent(5,67.77303);
   EM->SetBinContent(6,29.26645);
   EM->SetBinContent(7,9.194079);
   EM->SetBinContent(8,2.118421);
   EM->SetBinContent(9,0.3980263);
   EM->SetBinContent(10,0.07236842);
   EM->SetBinContent(11,0.003289474);
   EM->SetEntries(152963);
   ...
   text = ptstats->AddText("Entries = 152963 ");
   text = ptstats->AddText("Mean  =  2.482");
